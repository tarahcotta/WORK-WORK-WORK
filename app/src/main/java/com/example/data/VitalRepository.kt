            ...
            if (dao.getSessionCount() == 0) {
                ...
                val seedSessions = listOf(
                    ...
                    LoggedWorkoutSessionEntity(
                        ...
                        LoggedSetEntity(sessionId = 0, exerciseName = "Goblet Squat", setNumber = 1, weightLbs = 35f, repsCompleted = 10, rpeActual = 7, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Goblet Squat", setNumber = 2, weightLbs = 35f, repsCompleted = 10, rpeActual = 7, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Goblet Squat", setNumber = 3, weightLbs = 35f, repsCompleted = 10, rpeActual = 8, jointFeel = "Comfortable")
                    ),
                    // Week -4 session
                    LoggedWorkoutSessionEntity(
                        ...
                        LoggedSetEntity(sessionId = 0, exerciseName = "Hex Bar Deadlift", setNumber = 1, weightLbs = 115f, repsCompleted = 8, rpeActual = 7, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Hex Bar Deadlift", setNumber = 2, weightLbs = 115f, repsCompleted = 8, rpeActual = 8, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Hex Bar Deadlift", setNumber = 3, weightLbs = 115f, repsCompleted = 8, rpeActual = 8, jointFeel = "Comfortable")
                    ),
                    // Week -3 session
                    LoggedWorkoutSessionEntity(
                        routineDayTitle = "Day 1: Lower Body & Density",
                        ...
                        LoggedSetEntity(sessionId = 0, exerciseName = "Goblet Squat", setNumber = 1, weightLbs = 40f, repsCompleted = 10, rpeActual = 7, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Goblet Squat", setNumber = 2, weightLbs = 40f, repsCompleted = 10, rpeActual = 8, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Goblet Squat", setNumber = 3, weightLbs = 40f, repsCompleted = 10, rpeActual = 8, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Dumbbell Overhead Press", setNumber = 1, weightLbs = 25f, repsCompleted = 10, rpeActual = 7, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Dumbbell Overhead Press", setNumber = 2, weightLbs = 25f, repsCompleted = 10, rpeActual = 8, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Dumbbell Overhead Press", setNumber = 3, weightLbs = 25f, repsCompleted = 10, rpeActual = 8, jointFeel = "Comfortable")
                    ),
                    // Week -2 session
                    LoggedWorkoutSessionEntity(
                        routineDayTitle = "Day 2: Posterior Chain & Back",
                        ...
                        LoggedSetEntity(sessionId = 0, exerciseName = "Hex Bar Deadlift", setNumber = 1, weightLbs = 135f, repsCompleted = 8, rpeActual = 7, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Hex Bar Deadlift", setNumber = 2, weightLbs = 135f, repsCompleted = 8, rpeActual = 8, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Hex Bar Deadlift", setNumber = 3, weightLbs = 135f, repsCompleted = 8, rpeActual = 8, jointFeel = "Comfortable")
                    ),
                    // Week -1 session
                    LoggedWorkoutSessionEntity(
                        routineDayTitle = "Day 1: Lower Body & Density",
                        ...
                        LoggedSetEntity(sessionId = 0, exerciseName = "Goblet Squat", setNumber = 1, weightLbs = 45f, repsCompleted = 10, rpeActual = 7, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Goblet Squat", setNumber = 2, weightLbs = 45f, repsCompleted = 10, rpeActual = 8, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Goblet Squat", setNumber = 3, weightLbs = 45f, repsCompleted = 10, rpeActual = 8, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Dumbbell Overhead Press", setNumber = 1, weightLbs = 30f, repsCompleted = 10, rpeActual = 8, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Dumbbell Overhead Press", setNumber = 2, weightLbs = 30f, repsCompleted = 10, rpeActual = 8, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Dumbbell Overhead Press", setNumber = 3, weightLbs = 30f, repsCompleted = 10, rpeActual = 8, jointFeel = "Comfortable")
                    ),
                    ...
                    LoggedWorkoutSessionEntity(
                        ...
                        LoggedSetEntity(sessionId = 0, exerciseName = "Hex Bar Deadlift", setNumber = 1, weightLbs = 150f, repsCompleted = 8, rpeActual = 8, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Hex Bar Deadlift", setNumber = 2, weightLbs = 150f, repsCompleted = 8, rpeActual = 8, jointFeel = "Comfortable"),
                        LoggedSetEntity(sessionId = 0, exerciseName = "Hex Bar Deadlift", setNumber = 3, weightLbs = 150f, repsCompleted = 8, rpeActual = 8, jointFeel = "Comfortable")
                    )
                )
                dao.seedInitialSessionsIfEmpty(seedSessions)
            }
        } catch (e: Exception) {
